export default {
  ...
  login: {
    title: 'Hermes Web UI',
    description: 'Melden Sie sich mit Ihrem E-Mail-Bestatigungscode an.',
    ...
    codePlaceholder: 'Bestatigungscode',
    sendCode: 'Code senden',
    codeSent: 'Prufen Sie Ihre E-Mail auf den Bestatigungscode.',
    emailRequired: 'Bitte geben Sie Ihre E-Mail ein',
    codeRequired: 'Bitte geben Sie den Bestatigungscode ein',
    invalidCode: 'Der Bestatigungscode ist ungultig oder abgelaufen',
    emailCodeSendFailed: 'Bestatigungscode konnte nicht gesendet werden',
