export default {
  ...
  login: {
    title: 'Hermes Web UI',
    description: 'Entre com seu codigo de verificacao por email.',
    ...
    codeSent: 'Verifique seu email para o codigo de verificacao.',
    emailRequired: 'Por favor, insira seu email',
    codeRequired: 'Por favor, insira o codigo de verificacao',
    invalidCode: 'O codigo de verificacao e invalido ou expirou',
    emailCodeSendFailed: 'Falha ao enviar codigo de verificacao',
