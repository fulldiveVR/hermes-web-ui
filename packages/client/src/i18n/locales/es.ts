export default {
  ...
  login: {
    title: 'Hermes Web UI',
    description: 'Inicia sesion con tu codigo de verificacion por email.',
    ...
    emailMode: 'Email',
    passwordMode: 'Contrasena',
    emailPlaceholder: 'Email',
    codePlaceholder: 'Codigo de verificacion',
    sendCode: 'Enviar codigo',
    codeSent: 'Revisa tu email para ver el codigo de verificacion.',
    emailRequired: 'Introduce tu email',
    codeRequired: 'Introduce el codigo de verificacion',
    invalidCode: 'El codigo de verificacion no es valido o expiro',
    emailCodeSendFailed: 'No se pudo enviar el codigo de verificacion',
