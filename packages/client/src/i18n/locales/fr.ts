export default {
  ...
  login: {
    title: 'Hermes Web UI',
    description: 'Connectez-vous avec votre code de verification par e-mail.',
    ...
    codePlaceholder: 'Code de verification',
    sendCode: 'Envoyer le code',
    codeSent: 'Consultez votre e-mail pour le code de verification.',
    emailRequired: 'Veuillez entrer votre e-mail',
    codeRequired: 'Veuillez entrer le code de verification',
    invalidCode: 'Le code de verification est invalide ou expire',
    emailCodeSendFailed: 'Echec de l\'envoi du code de verification',
